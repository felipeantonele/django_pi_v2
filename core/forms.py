...
class AssociateDataModelForm(forms.ModelForm):
    ...
    responsible_1 = forms.CharField(label='Nome do Responsável 1', max_length=100, min_length=0)
    responsible_2 = forms.CharField(label='Nome do Responsável 2', max_length=100, min_length=0)
